    ...
    <v-container fluid>
        <v-container fluid v-if="play">
            ...
            <video  width="100%"
                ...
                <!-- <track id="subEN" label="English" kind="subtitles" srclang="en" :src="subEN"> -->
                <!--<track id="subFR" label="Français" kind="subtitles" srclang="fr" :src="subFR">-->
            </video>
            <div class="" v-if="dl">
                <v-progress-linear
                        color="info"
                ...
                if (html5Video !== null) {
                    ...
                    this.vjs.ready(() => {
                        ...
                        this.vjs.currentTime = (time) => {
                            // if (time / vjs.duration() < 0.4) {
                            // if (time) {
                            if (time && this.isComplete) {
                                //const url = new URL(vjs.currentSrc())
                        ...
                        // const videojs = this.vjs
                        // console.log('videojs.play : ', videojs.play());
                        // videojs.on('pause', ()=> {
                        //     console.log('pause');
                        //     if (videojs.paused())
                        //         console.log('paused');
                        ...
                        //     // console.log('videojs.play : ', this.vjs.play());
                        // })
                        // this.vjs.on('play', ()=> {
                        //     console.log('play');
                        //     console.log('videojs.play : ', this.vjs.play());
        ...
        async mounted() {
            ...
            if (cookie === undefined || cookie === "") {
                ...
                this.socket.on('stream', async (data) => {
                    let torrent = res.data.data.movie.torrents[0]
